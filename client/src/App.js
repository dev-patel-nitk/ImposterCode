...
<div className="lobby-header">
  <div className="header-left">
    <h1 className="logo-text">IMPOSTERCODE</h1>
  </div>

  <div className="header-right">
    <div className="profile-trigger" onClick={() => handleOpenProfile(user)}>
      <div className="user-details">
        <span className="user-rank">PILOT</span> {/* Placeholder for Rank */}
