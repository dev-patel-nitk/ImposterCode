module.exports = (() => {
  ...
  const solveValidParentheses = (s) => {
    ...
    for (let char of s) {
      ...
      else if (stack.pop() !== map[char]) return "0"; 
    }
  ...
  // ==========================================
  // 🟢 COMPILED QUESTION LIST (ALL 28 QUESTIONS)
  // ==========================================
  return [
    {
      ...
      "testCases": [
        ...
        { "input": "3 6\n3 2 4", "output": "1 2" },
        { "input": "2 6\n3 3", "output": "0 1" },
        { "input": "5 9\n1 2 3 4 5", "output": "3 4" },
        { "input": `${twoSumNums.length} ${twoSumTarget}\n${twoSumNums.join(' ')}`, "output": solveTwoSum(twoSumNums, twoSumTarget) }
      ],
      "tags": ["Array", "Hash Map"]
    },
    {
      ...
      "testCases": [
        ...
        { "input": "{[]}", "output": "1" },
        { "input": "([)]", "output": "0" },
        { "input": vpStr, "output": solveValidParentheses(vpStr) }
      ],
      "tags": ["Stack", "String"]
    },
    {
      ...
      "difficulty": "medium",
      "description": "Given a string `s`, find the **length** of the longest substring without repeating characters.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: A single string `s`.\n\n**Output Format:**\n- Print the length as a single integer on a new line.",
    ...
    },
    {
      ...
      "testCases": [
        ...
        { "input": "3\n3 0 3", "output": "3" },
        { "input": "5\n3 0 2 0 4", "output": "7" },
        { "input": `${twNums.length}\n${twNums.join(' ')}`, "output": solveTrappingWater(twNums) }
      ],
    ...
    },
    {
      ...
      "title": "Single Number",
      "difficulty": "easy",
      "description": "Given a non-empty array of integers, every element appears twice except for one. Find that single one.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (size of array).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print the single number on a new line.",
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Given an array of size N, return the majority element (appears more than N/2 times).\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (size of array).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print the majority element on a new line.",
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Given a string `s` consisting of words and spaces, return the length of the last word in the string.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: An integer `N` indicating string segments (read full line).\n  - Line 2: The string `s`.\n\n**Output Format:**\n- Print the length on a new line.",
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Given an array containing `N` distinct numbers in the range `[0, N]`, return the only number missing from the array.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (size of array).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print the missing number on a new line.",
    ...
    },
    {
      ...
      "difficulty": "medium",
      "description": "Suppose an array of length `N` sorted in ascending order is rotated between 1 and `N` times. Return the minimum element.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (size of array).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print the minimum element on a new line.",
      "constraints": ["1 <= N <= 5000", "Elements are unique."],
      "sampleInput": "2\n5\n3 4 5 1 2\n7\n4 5 6 7 0 1 2",
      "sampleOutput": "1\n0",
      "testCases": [
        { "input": "5\n3 4 5 1 2", "output": "1" },
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Given a string `s`, find the first non-repeating character in it and return its index. If it does not exist, return `-1`.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: String `s`.\n\n**Output Format:**\n- Print the index or `-1` on a new line.",
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Given an integer `x`, determine if it reads the same backward as forward.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: An integer `x`.\n\n**Output Format:**\n- Print `1` if it is a palindrome, else `0` on a new line.",
      "constraints": ["-2^31 <= x <= 2^31 - 1"],
      "sampleInput": "2\n121\n-121",
      "sampleOutput": "1\n0",
      "testCases": [
    ...
    },
    {
      ...
      "title": "Move Zeroes",
      "difficulty": "easy",
      "description": "Given an integer array `nums`, move all `0`s to the end of it while maintaining the relative order of the non-zero elements.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (size of array).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print the modified array as space-separated integers on a new line.",
      "constraints": ["1 <= N <= 10^4"],
      "sampleInput": "2\n5\n0 1 0 3 12\n1\n0",
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Given a string `s`, reverse only all the vowels in the string and return it.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: A string `s`.\n\n**Output Format:**\n- Print the modified string on a new line.",
    ...
    },
    {
      ...
      "difficulty": "easy",
      "description": "Write a function that takes an unsigned integer and returns the number of '1' bits it has (also known as the Hamming weight).\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: An integer `n`.\n\n**Output Format:**\n- Print the number of 1 bits on a new line.",
    ...
    },
    {
      ...
      "difficulty": "medium",
      "description": "Given an integer array `nums` sorted in ascending order that is possibly rotated, and a `target`, return the index of `target`. If not found, return `-1`.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` and `target` (separated by space).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print the index or `-1` on a new line.",
      "constraints": ["1 <= N <= 10^4"],
      "sampleInput": "2\n7 0\n4 5 6 7 0 1 2\n7 3\n4 5 6 7 0 1 2",
      "sampleOutput": "4\n-1",
      "testCases": [
        ...
        { "input": "2 3\n1 3", "output": "1" },
        { "input": "5 4\n1 2 3 4 5", "output": "3" },
        { "input": `${rotatedNums.length} ${rotatedTarget}\n${rotatedNums.join(' ')}`, "output": solveSearchRotated(rotatedNums, rotatedTarget) }
      ],
      "tags": ["Array", "Binary Search"]
    },
    {
      ...
      "testCases": [
        ...
        { "input": `${productNums.length}\n${productNums.join(' ')}`, "output": solveProductExceptSelf(productNums) }
      ],
    ...
    },
    {
      ...
      "title": "Jump Game",
      "difficulty": "medium",
      "description": "You are given an integer array `nums`. Each element represents your maximum jump length from that index. Return true if you can reach the last index.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (size of array).\n  - Line 2: `N` space-separated integers.\n\n**Output Format:**\n- Print `1` if true, `0` if false on a new line.",
      "constraints": ["1 <= N <= 10^4"],
      "sampleInput": "2\n5\n2 3 1 1 4\n5\n3 2 1 0 4",
      "sampleOutput": "1\n0",
      "testCases": [
        ...
        { "input": "3\n2 0 0", "output": "1" },
        { "input": "4\n1 0 1 0", "output": "0" },
        { "input": `${jumpNums.length}\n${jumpNums.join(' ')}`, "output": solveJumpGame(jumpNums) }
      ],
      "tags": ["Array", "Greedy"]
    },
    {
      ...
      "difficulty": "medium",
      "description": "Find two lines that together with the x-axis form a container, such that the container contains the most water.\n\n**Input Format:**\n- Line 1: An integer `T` representing the number of test cases.\n- For each testcase:\n  - Line 1: `N` (number of vertical lines).\n  - Line 2: `N` space-separated integers representing heights.\n\n**Output Format:**\n- Print the maximum area as a single integer on a new line.",
      "constraints": ["2 <= N <= 10^4"],
      "sampleInput": "2\n9\n1 8 6 2 5 4 8 3 7\n2\n1 1",
      "sampleOutput": "49\n1",
      "testCases": [
